...
🔹 I used a custom dataset with over 4000 handwritten Nepali word images.
 🔹 Trained a deep learning model with attention mechanisms.
 🔹 Character set included vowels, consonants, ligatures, and special diacritics from the Nepali script.
✨ Results:
...
Handwriting variability is large — different people write very differently.
...
🔍 Lessons Learned:
 Working with regional languages like Nepali in OCR is tough but exciting — it needs a mix of deep learning, NLP, and image processing skills.
 Still a long way to go, but I’m proud of the first milestone. 🚀
💬 If you’re working on OCR, multilingual NLP, or low-resource language AI — I’d love to connect! Let's push the boundaries together.
